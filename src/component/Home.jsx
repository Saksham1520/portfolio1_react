...
export default function Home() {
  return (
    ...
    <img src="assignpng.png" class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">Component-1</h5>
      <p class="card-text"></p>
      <Link to="/Like" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
    ...
    <div class="card-body">
      ...
      <p class="card-text"></p>
      <Link to="/card" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
    ...
    <div class="card-body">
      ...
      <p class="card-text"></p>
      <Link to="/condrend" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
  </div>
    ...
    <div class="card-body">
      ...
      <p class="card-text"></p>
      <Link to="/counter" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
    ...
    <div class="card-body">
      ...
      <p class="card-text"></p>
      <Link to="/eval" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
    ...
    <div class="card-body">
      ...
      <p class="card-text"></p>
      <Link to="/demotodo" class="btn btn-primary">Open it!</Link>
    </div>
  </div>
  </div>
</div>
